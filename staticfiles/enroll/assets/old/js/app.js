    ...
    t("#sidebar-menu a").each(function () {
        ...
        if (this.href === currentUrl) {
            ...
            $this.parents('li').each(function (index) {
                t(this).addClass(index === 0 ? "mm-active" : "mm-show");
            });
        }
    }),
...
!(function ($) {
  ...
  var MainApp = function () {
    (this.$body = $("body")), (this.$wrapper = $("#wrapper")), this.init();
  };
          ...
          if ($(this).prop("checked")) {
            ...
            if ($(this).attr("id") === "light-mode-switch") {
              $("#bootstrap-style").attr(
                "href",
                "{% static 'enroll/assets/css/bootstrap.min.css' %}"
              );
              $("#app-style").attr(
                "href",
                "{% static 'enroll/assets/css/app.min.css' %}"
              );
            } else if ($(this).attr("id") === "dark-mode-switch") {
              $("#bootstrap-style").attr(
                "href",
                "{% static 'enroll/assets/css/bootstrap-dark.min.css' %}"
              );
              $("#app-style").attr(
                "href",
                "{% static 'enroll/assets/css/app-dark.min.css' %}"
              );
              ...
              $("#app-style").attr(
                "href",
                "{% static 'enroll/assets/css/app-rtl.min.css' %}"
              );
            }
          }
        }
